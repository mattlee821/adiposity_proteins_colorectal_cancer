...
plot_data$outcome <- factor(plot_data$outcome, levels = c(
  "overall", "overall-HRC-EUR", "colon", "proximal", "distal", "rectal"))
...
plot_data$order[plot_data$outcome == "overall-HRC-EUR"] <- 2
plot_data$order[plot_data$outcome == "colon"] <- 3
plot_data$order[plot_data$outcome == "distal"] <- 4
plot_data$order[plot_data$outcome == "proximal"] <- 5
plot_data$order[plot_data$outcome == "rectal"] <- 6
