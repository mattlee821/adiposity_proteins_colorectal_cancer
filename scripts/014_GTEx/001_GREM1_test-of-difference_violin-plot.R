...
length(unique(plot_data$SMTSD))

results <- bind_rows(result_combined, result_female, result_male)
results <-subset(results, p_value > 0.05/53)

tiff(filename = "analysis/figures/GTEx-violin_GREM1.tiff",
