...
filenames <- c("Stratified_distal_Meta_125K_Results.tsv.annotated.txt_with_header.txt")
...
write.table(outcomes, "analysis/009_colocalisation/outcome_data/000_stratified_distal.txt",
