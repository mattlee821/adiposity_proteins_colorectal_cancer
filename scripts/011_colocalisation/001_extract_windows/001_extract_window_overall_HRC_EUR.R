...
filenames <- c("MarginalMeta_HRC_EUR_only_Results.tsv.annotated.txt_with_header.txt")
...
for (i in 1:length(exposure_list)){
    ...
    outcome_list[[i]]$outcome <- "overall_HRC_EUR"
...
write.table(outcomes, "analysis/009_colocalisation/outcome_data/000_overall_HRC_EUR.txt",
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

#save("analysis/009_colocalisation/outcome_data/000_overall_HRC_EUR.RData")