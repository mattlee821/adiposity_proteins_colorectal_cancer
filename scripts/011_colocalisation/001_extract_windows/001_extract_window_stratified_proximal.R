...
filenames <- c("Stratified_proximal_Meta_125K_Results.tsv.annotated.txt_with_header.txt")
...
write.table(outcomes, "analysis/009_colocalisation/outcome_data/000_stratified_proximal.txt",
