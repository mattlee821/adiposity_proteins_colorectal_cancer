...
harmonise_data_list <- fread("analysis/009_colocalisation/results/stratified_distal/harmonise_data.txt")
...
for (i in 1290:length(harmonise_data_list)){
...
write.table(table_master, "analysis/009_colocalisation/results/stratified_distal/001_coloc_results_missing.txt", 
