...
harmonise_data_list <- fread("analysis/009_colocalisation/results/joint_rectal_male/harmonise_data.txt")
...
for (i in 936:length(harmonise_data_list)){
...
write.table(table_master, "analysis/009_colocalisation/results/joint_rectal_male/001_coloc_results_missing.txt", 
