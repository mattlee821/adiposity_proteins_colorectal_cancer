...
harmonise_data_list <- fread("analysis/009_colocalisation/results/stratified_colon/harmonise_data.txt")
...
for (i in 1178:length(harmonise_data_list)){
...
write.table(table_master, "analysis/009_colocalisation/results/stratified_colon/001_coloc_results_missing.txt", 
