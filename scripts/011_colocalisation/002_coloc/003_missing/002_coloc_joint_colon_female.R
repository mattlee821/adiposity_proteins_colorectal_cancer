...
harmonise_data_list <- fread("analysis/009_colocalisation/results/joint_colon_female/harmonise_data.txt")
...
write.table(table_master, "analysis/009_colocalisation/results/joint_colon_female/001_coloc_results_missing.txt", 
