...
harmonise_data_list <- fread("analysis/009_colocalisation/results/joint_rectal_female/harmonise_data.txt")
...
for (i in 852:length(harmonise_data_list)){
...
write.table(table_master, "analysis/009_colocalisation/results/joint_rectal_female/001_coloc_results_missing.txt", 
