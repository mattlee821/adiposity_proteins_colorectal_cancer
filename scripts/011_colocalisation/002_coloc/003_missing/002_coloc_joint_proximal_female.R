...
# data ====
files <- list.files("analysis/009_colocalisation/results", pattern = "harmonise_data", recursive = TRUE, full.names = TRUE)
harmonise_data_list <- fread("analysis/009_colocalisation/results/joint_proximal_female/harmonise_data.txt")
...
for (i in 836:length(harmonise_data_list)){
...
write.table(table_master, "analysis/009_colocalisation/results/joint_proximal_female/001_coloc_results_missing.txt", 
