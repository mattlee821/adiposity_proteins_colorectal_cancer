...
harmonise_data_list <- fread("analysis/009_colocalisation/results/stratified_female/harmonise_data.txt")
...
for (i in 292:length(harmonise_data_list)){
...
write.table(table_master, "analysis/009_colocalisation/results/stratified_female/001_coloc_results_missing.txt", 
