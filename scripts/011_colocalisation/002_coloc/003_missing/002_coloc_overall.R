...
harmonise_data_list <- fread("analysis/009_colocalisation/results/overall/harmonise_data.txt")
...
for (i in 1239:length(harmonise_data_list)){
...
write.table(table_master, "analysis/009_colocalisation/results/overall/001_coloc_results_missing.txt", 
