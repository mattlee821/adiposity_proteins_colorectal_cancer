...
harmonise_data_list <- fread("analysis/009_colocalisation/results/joint_colon_male/harmonise_data.txt")
...
write.table(table_master, "analysis/009_colocalisation/results/joint_colon_male/001_coloc_results_missing.txt", 
