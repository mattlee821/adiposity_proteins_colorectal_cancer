...
harmonise_data_list <- fread("analysis/009_colocalisation/results/stratified_male/harmonise_data.txt")
...
for (i in 1298:length(harmonise_data_list)){
...
write.table(table_master, "analysis/009_colocalisation/results/stratified_male/001_coloc_results_missing.txt", 
