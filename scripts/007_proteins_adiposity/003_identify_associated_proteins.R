...
# data ====
data <- read.table("analysis/005_proteins_adiposity/001_MR_results.txt", header = T, sep = "\t")
...
write.table(a, "analysis/005_proteins_adiposity/002_bmi_male_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
a <- subset(data_whr_male, direction_group != "inconsistent")
write.table(a, "analysis/005_proteins_adiposity/002_whr_male_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
a <- subset(data_bmi_female, direction_group != "inconsistent")
write.table(a, "analysis/005_proteins_adiposity/002_bmi_female_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
a <- subset(data_whr_female, direction_group != "inconsistent")
write.table(a, "analysis/005_proteins_adiposity/002_whr_female_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
a <- subset(data_bmi_combined, direction_group != "inconsistent")
write.table(a, "analysis/005_proteins_adiposity/002_bmi_combined_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
a <- subset(data_whr_combined, direction_group != "inconsistent")
write.table(a, "analysis/005_proteins_adiposity/002_whr_combined_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
write.table(table, "analysis/005_proteins_adiposity/table_N_p_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
directionally_associated_bmi_male <- read.table("analysis/005_proteins_adiposity/002_bmi_male_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_bmi_male <- directionally_associated_bmi_male$sequence_id
directionally_associated_whr_male <- read.table("analysis/005_proteins_adiposity/002_whr_male_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_whr_male <- directionally_associated_whr_male$sequence_id
directionally_associated_bmi_female <- read.table("analysis/005_proteins_adiposity/002_bmi_female_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_bmi_female <- directionally_associated_bmi_female$sequence_id
directionally_associated_whr_female <- read.table("analysis/005_proteins_adiposity/002_whr_female_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_whr_female <- directionally_associated_whr_female$sequence_id
directionally_associated_bmi_combined <- read.table("analysis/005_proteins_adiposity/002_bmi_combined_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_bmi_combined <- directionally_associated_bmi_combined$sequence_id
directionally_associated_whr_combined <- read.table("analysis/005_proteins_adiposity/002_whr_combined_directionally_associated_proteins.txt", header = T, sep = "\t")
...
write.table(table, "analysis/005_proteins_adiposity/table_N_p_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
write.table(data_associations, "analysis/005_proteins_adiposity/003_phenospd_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")


# unqiue associations table
data <- read.table("analysis/005_proteins_adiposity/003_phenospd_directionally_associated_proteins.txt", header = T, sep = "\t")
...
write.table(table, "analysis/005_proteins_adiposity/table_N_unique_associations.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
