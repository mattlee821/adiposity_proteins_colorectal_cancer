...
# make dataframe
data <- data[, c("id", "sequence_id", "b", "group", "outcome")]
...
data_rectal_male <- data_rectal_male[,c("id", "sequence_id", "b")]
...
table <- data.frame(
  outcome = c("overall", "overall_HRC", "colon", "distal", "proximal", "rectal"),
...
# 
write.table(table, "analysis/003_proteins_colorectal/table_N_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

# save directionally associated protein lists ====
a <- subset(data_colon_male, direction_group != "inconsistent")
write.table(a, "analysis/003_proteins_colorectal/002_colon_male_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
a <- subset(data_distal_male, direction_group != "inconsistent")
write.table(a, "analysis/003_proteins_colorectal/002_distal_male_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
a <- subset(data_proximal_male, direction_group != "inconsistent")
write.table(a, "analysis/003_proteins_colorectal/002_proximal_male_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
a <- subset(data_rectal_male, direction_group != "inconsistent")
write.table(a, "analysis/003_proteins_colorectal/002_rectal_male_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
a <- subset(data_overall_male, direction_group != "inconsistent")
write.table(a, "analysis/003_proteins_colorectal/002_overall_male_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

a <- subset(data_colon_female, direction_group != "inconsistent")
write.table(a, "analysis/003_proteins_colorectal/002_colon_female_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
a <- subset(data_distal_female, direction_group != "inconsistent")
write.table(a, "analysis/003_proteins_colorectal/002_distal_female_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
a <- subset(data_proximal_female, direction_group != "inconsistent")
write.table(a, "analysis/003_proteins_colorectal/002_proximal_female_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
a <- subset(data_rectal_female, direction_group != "inconsistent")
write.table(a, "analysis/003_proteins_colorectal/002_rectal_female_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
a <- subset(data_overall_female, direction_group != "inconsistent")
write.table(a, "analysis/003_proteins_colorectal/002_overall_female_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

a <- subset(data_colon_combined, direction_group != "inconsistent")
write.table(a, "analysis/003_proteins_colorectal/002_colon_combined_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
a <- subset(data_distal_combined, direction_group != "inconsistent")
write.table(a, "analysis/003_proteins_colorectal/002_distal_combined_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
a <- subset(data_proximal_combined, direction_group != "inconsistent")
write.table(a, "analysis/003_proteins_colorectal/002_proximal_combined_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
a <- subset(data_rectal_combined, direction_group != "inconsistent")
write.table(a, "analysis/003_proteins_colorectal/002_rectal_combined_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
a <- subset(data_overall_combined, direction_group != "inconsistent")
write.table(a, "analysis/003_proteins_colorectal/002_overall_combined_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
a <- subset(data_overall_HRC_combined, direction_group != "inconsistent")
write.table(a, "analysis/003_proteins_colorectal/002_overall_HRC_combined_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
data <- data[, c("id", "sequence_id", "pval", "group", "outcome")]
...
# make table of N 
table_p1 <- data.frame(
  outcome = c("overall", "overall_HRC", "colon", "distal", "proximal", "rectal", "unique"),
...
write.table(table, "analysis/003_proteins_colorectal/table_N_p_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
directionally_associated_colon_male <- read.table("analysis/003_proteins_colorectal/002_colon_male_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_colon_male <- directionally_associated_colon_male$sequence_id
directionally_associated_distal_male <- read.table("analysis/003_proteins_colorectal/002_distal_male_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_distal_male <- directionally_associated_distal_male$sequence_id
directionally_associated_rectal_male <- read.table("analysis/003_proteins_colorectal/002_rectal_male_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_rectal_male <- directionally_associated_rectal_male$sequence_id
directionally_associated_proximal_male <- read.table("analysis/003_proteins_colorectal/002_proximal_male_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_proximal_male <- directionally_associated_proximal_male$sequence_id
directionally_associated_overall_male <- read.table("analysis/003_proteins_colorectal/002_overall_male_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_overall_male <- directionally_associated_overall_male$sequence_id

directionally_associated_colon_female <- read.table("analysis/003_proteins_colorectal/002_colon_female_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_colon_female <- directionally_associated_colon_female$sequence_id
directionally_associated_distal_female <- read.table("analysis/003_proteins_colorectal/002_distal_female_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_distal_female <- directionally_associated_distal_female$sequence_id
directionally_associated_rectal_female <- read.table("analysis/003_proteins_colorectal/002_rectal_female_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_rectal_female <- directionally_associated_rectal_female$sequence_id
directionally_associated_proximal_female <- read.table("analysis/003_proteins_colorectal/002_proximal_female_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_proximal_female <- directionally_associated_proximal_female$sequence_id
directionally_associated_overall_female <- read.table("analysis/003_proteins_colorectal/002_overall_female_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_overall_female <- directionally_associated_overall_female$sequence_id

directionally_associated_colon_combined <- read.table("analysis/003_proteins_colorectal/002_colon_combined_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_colon_combined <- directionally_associated_colon_combined$sequence_id
directionally_associated_distal_combined <- read.table("analysis/003_proteins_colorectal/002_distal_combined_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_distal_combined <- directionally_associated_distal_combined$sequence_id
directionally_associated_rectal_combined <- read.table("analysis/003_proteins_colorectal/002_rectal_combined_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_rectal_combined <- directionally_associated_rectal_combined$sequence_id
directionally_associated_proximal_combined <- read.table("analysis/003_proteins_colorectal/002_proximal_combined_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_proximal_combined <- directionally_associated_proximal_combined$sequence_id
directionally_associated_overall_combined <- read.table("analysis/003_proteins_colorectal/002_overall_combined_directionally_associated_proteins.txt", header = T, sep = "\t")
directionally_associated_overall_combined <- directionally_associated_overall_combined$sequence_id
directionally_associated_overall_HRC_combined <- read.table("analysis/003_proteins_colorectal/002_overall_HRC_combined_directionally_associated_proteins.txt", header = T, sep = "\t")
...
write.table(table, "analysis/003_proteins_colorectal/table_N_p_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
data_associations <- bind_rows(
  ...
  data_overall_combined, data_overall_HRC_combined, data_colon_combined, data_distal_combined, data_proximal_combined, data_rectal_combined)

write.table(data_associations, "analysis/003_proteins_colorectal/003_phenospd_directionally_associated_proteins.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
write.table(table, "analysis/003_proteins_colorectal/table_N_unique_associations.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
